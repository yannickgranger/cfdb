//! Architecture test — source-level determinism invariants for cfdb-extractor-ts.
//!
...
#[test]
fn cfdb_extractor_ts_src_has_no_determinism_breaking_patterns() {

//! Architecture test — source-level determinism invariants for cfdb-extractor-php.
//!
...
#[test]
fn cfdb_extractor_php_src_has_no_determinism_breaking_patterns() {
